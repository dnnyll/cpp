...
/*   Updated: 2026/02/11 10:29:34 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	c = b;	// Copy assignment operator called → this = c, source = b, copies _rawBits

	/*	
		when the code hits this equal sign, it will look and call the
		function: Fixed &Fixed::operator=(const Fixed &source)
		within this function, the keyword "this" will get the value
		stored in c and source will get the value stored in b
		it will then check if this != &source to avoid self-assignment
		and copy the internal _rawBits from source into this
		finally it will return *this so that chained assignments will work
	*/
