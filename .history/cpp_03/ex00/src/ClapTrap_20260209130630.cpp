...
/*   Updated: 2026/02/09 13:06:30 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string& target)
{
	if (_hitPoints == 0)
	{
		std::cout	<< "ClapTrap" << _name
					<< "cannot attack because it's already destroyed."
					<< std::endl;
		return ;
	}
	if (_energyPoints == 0)
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		std::cout	<< "ClapTrap" << _name
					<< " cannot repair because it's already destroyed."
					<< std::endl;
		return ;
	}
	if (_energyPoints == 0)
	{
		std::cout	<< "ClapTrap " << _name
					<< " cannot repair becuase energy is depleted."
					<< std::endl;
		return ;
	}
	if (_hitPoints == 10)
