...
/*   Updated: 2026/02/19 11:09:12 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	while (indexAnimals < numberAnimals / 2)
	{
		animals[indexAnimals] = new Cat();
		animals[indexAnimals]->makeSound();
		indexAnimals++;
	}
	jndexAnimals = indexAnimals;
