...
/*   Updated: 2026/02/17 14:50:05 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const WrongAnimal *wrongCatBase = new WrongCat();
	- creates an object WrongCat
	- wrongCatBase stores address of object

The pointer type tells the compiler what the pointer is allowed to see.

wrongCatBase is a pointer, but its type is WrongAnimal*, so:
