...
/*   Updated: 2026/02/20 12:45:34 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	/*
	Because makeSound is virtual in Animal, cat->makeSound() calls the override in Cat, not the base function. This is polymorphism in action.
	*/
	...
	/*
		...
		but the base class (WrongAnimal) did not declare it virtual.
	...
	|	step: makeSound() Call                               |
	|		- Pointer type: WrongAnimal*                     |
	|		- Actual object type: WrongCat                   |
