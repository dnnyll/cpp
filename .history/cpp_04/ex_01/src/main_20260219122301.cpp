...
/*   Updated: 2026/02/19 12:23:01 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
while (iAnimals < nAnimals)
{
    ...
    // Print the first two ideas
    std::cout << "[DEBUG] " << type 
              << " idea[0]: " << animals[iAnimals]->getIdea(0) << std::endl;
    std::cout << "[DEBUG] " << type 
              << " idea[1]: " << animals[iAnimals]->getIdea(1) << std::endl;
...
{
    std::string type = animals[iAnimals]->getType();
    std::cout << "[DEBUG] Deleting " << type << " at index " << iAnimals << std::endl;

    delete animals[iAnimals]; // calls Cat/Dog destructor, deletes Brain
    iAnimals++;
}

std::cout << "[DEBUG] Finished deleting all animals\n" << std::endl;
