...
/*   Updated: 2026/02/20 10:37:14 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	//	Combat: different takeDamage values + repair max hitpoints
	{
		std::cout << "Constructing constestents...\n" << std::endl;
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	std::cout << "\nLaunching ScavTrap Tournament..." << std::endl;
	{
		std::cout << "Constructing constestents...\n" << std::endl;
