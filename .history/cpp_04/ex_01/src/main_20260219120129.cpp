...
/*   Updated: 2026/02/19 12:01:29 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	while (iAnimals < nAnimals)
	{
		animals[iAnimals]->setIdea(0, type == "Cat" ? "I want fish!" : "I want a bone!");
a	nimals[iAnimals]->setIdea(1, type == "Cat" ? "Climb the tree" : "Chase the ball");
