...
/*   Updated: 2026/02/09 15:00:13 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        std::cout << "ClapTrap " << _name
                  << " cannot repair because it's destroyed." << std::endl;
        return;
    }
    ...
    {
        std::cout << "ClapTrap " << _name
                  << " cannot repair because its energy is depleted." << std::endl;
        return;
    }

    _hitPoints += amount;
    if (_hitPoints > 10)   // cap max HP at 10
        _hitPoints = 10;
    ...
    _energyPoints--;  // cost 1 energy point
}
