...
/*   Updated: 2026/02/19 14:11:58 by daniefe2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "[Cat]\toriginal Cat idea[0]:\t" << originalCat.getIdea(0) << std::endl;
	std::cout << "[Cat] copy idea[0]:\t" << copyCat.getIdea(0) << std::endl;
